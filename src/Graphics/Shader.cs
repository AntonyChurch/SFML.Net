...
namespace SFML.Graphics
{
    ...
    public class Shader : ObjectBase
    {
        ...
        #region Imports
        [DllImport("libcsfml-graphics", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport("libcsfml-graphics", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity, Obsolete]
